...
import { NQBarChart, Bar, XAxis as BarXAxis, Grid as BarGrid, Legend as BarLegend, Tooltip as BarTooltip } from "@nqlib/nqchart/bar-chart";
import { NQScatterChart, Scatter, XAxis as ScatterXAxis, YAxis, Grid as ScatterGrid, Legend as ScatterLegend, Tooltip as ScatterTooltip } from "@nqlib/nqchart/scatter-chart";
import { NQRadarChart, Radar, PolarGrid, PolarAngleAxis, Legend as RadarLegend, Tooltip as RadarTooltip } from "@nqlib/nqchart/radar-chart";
import { NQFunnelChart, Stages, XAxis as FunnelXAxis, YAxis as FunnelYAxis, Legend as FunnelLegend, Tooltip as FunnelTooltip } from "@nqlib/nqchart/funnel-chart";
import { NQWaterfallChart, Bars, Grid as WfGrid, XAxis as WfXAxis, YAxis as WfYAxis, Legend as WfLegend, Tooltip as WfTooltip } from "@nqlib/nqchart/waterfall-chart";
import { NQTreemapChart, Tiles, Tooltip as TreemapTooltip } from "@nqlib/nqchart/treemap-chart";
