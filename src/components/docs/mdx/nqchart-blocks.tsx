...
const CHART_INDEX = [
  ...
  { name: "Bar Chart", description: "Compare categories — vertical, horizontal, histogram, brush.", href: "/docs/nqchart/bar-chart" },
  { name: "Composed Chart", description: "Mix lines, bars, areas, and whiskers in one view.", href: "/docs/nqchart/composed-chart" },
  ...
  { name: "Radial Chart", description: "Gauges and radial bars with collision-aware labels.", href: "/docs/nqchart/radial-chart" },
  ...
  { name: "Funnel Chart", description: "Stage conversion — trapezoid or smooth pipe ribbon.", href: "/docs/nqchart/funnel-chart" },
