...
description: "nqui is a composed product UI kit for React + Tailwind v4 — not a second design language and not a static prop encyclopedia. Tokens and variants are real contra"
---
...
6. **Clarity, deference, depth** — content leads; chrome yields; elevation and overlays mean something (see [Overlays](/docs/nqui/overlays), [Layout and surfaces](/docs/nqui/layout-and-surfaces)).
