...
description: "In one short session, install `@nqlib/nqui`, wire CSS, compose a Button + Field, and open the live catalog so you know where variants live."
---
...
See [Actions and selection](/docs/nqui/actions-and-selection), [Forms and fields](/docs/nqui/forms-and-fields), [Practice in catalog](/docs/nqui/practice-in-catalog).
...
- You need package philosophy / boundaries → [Design philosophy](/docs/nqui/philosophy).
