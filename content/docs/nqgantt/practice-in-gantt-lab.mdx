...
description: "The live Timeline demo is a safe sandbox to learn links, lag, and strict vs flexible without worrying about production data."
---
...
3. Read [Auto-schedule](/docs/nqgantt/auto-schedule).
