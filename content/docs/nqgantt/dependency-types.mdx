...
description: "Type answers *which ends* of the two bars are tied. It is a property of the link, not of a bar and not of the whole chart."
---
...
- Do not change type without checking [Auto-schedule](/docs/nqgantt/auto-schedule): under strict mode, successors will move.
