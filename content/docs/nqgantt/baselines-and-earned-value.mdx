---
title: "Baselines and earned value"
description: "Give you a plan that has stopped moving, so that \"are we behind?\" and \"will this cost more than we said?\" have answers you can defend in a steering meeting."
---
...
- [Actuals and the worklog](/docs/nqgantt/actuals-and-worklog) — where actual cost should come from
- [Critical path](/docs/nqgantt/critical-path) — schedule risk, the other half of the picture
- [PMO playbook](/docs/nqgantt/pmo-playbook) — rolling this out to a team
