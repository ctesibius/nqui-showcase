...
description: "Let the left-hand list be the place you actually work — enter status, owner, effort, budget and dates inline — instead of a label strip you read while editing s"
---
...
- [Bars and timeline](/docs/nqgantt/bars-and-timeline) — the other half of the same rows
- [Auto-schedule](/docs/nqgantt/auto-schedule) — what a typed date triggers
- [Baselines and earned value](/docs/nqgantt/baselines-and-earned-value) — where budget columns end up
