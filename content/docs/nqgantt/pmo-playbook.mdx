...
Train the **difference** between link geometry ([Dependency types](/docs/nqgantt/dependency-types)) and enforcement ([Auto-schedule](/docs/nqgantt/auto-schedule)) early—Monday migrants will look for “flexible/strict” first ([Monday.com mapping](/docs/nqgantt/monday-com-mapping)).
...
- [Monday.com mapping](/docs/nqgantt/monday-com-mapping)
