---
title: "MS Project interop"
description: "Let a plan move in and out without being retyped, so adopting this does not mean abandoning the schedule somebody already built."
---
...
- [Dependency types](/docs/nqgantt/dependency-types) — the link types that come across
- [Baselines and earned value](/docs/nqgantt/baselines-and-earned-value) — baselines travel with the file
