---
title: "Critical path"
description: "Critical path highlights the chain of work where delay directly delays the project finish—based on the dependency network, not on bar color or gut feel."
---
...
It is only as good as your [Dependencies](/docs/nqgantt/dependencies). Missing links make a “short” critical path that is a lie.
...
Critical path **analyzes** the network. [Auto-schedule](/docs/nqgantt/auto-schedule) **enforces** it when you drag. You can view critical path with auto-schedule off; you can run strict schedule without showing critical styling.
