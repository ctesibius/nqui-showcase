...
Monday.com users: see [Monday.com mapping](/docs/nqgantt/monday-com-mapping). Per-edge flex/strict is an intended direction; today the showcase lab uses a **chart-level** toggle.
