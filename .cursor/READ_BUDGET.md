...
| **Docs library / MDX / nqchart sync** | `docs/nqchart/` + `content/docs/` + `src/pages/docs-page.tsx` | `pnpm docs:sync:nqchart` · `pnpm docs:sync:nqgantt` · `src/components/docs/` | inventing a second docs site in `../nqui` |
